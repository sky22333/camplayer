...
namespace uac {
    ...
    public:
        ...
        /**
         * Android (AUSBC libusb100): open via libusb_init2 + libusb_get_device_with_fd.
         * Standard libusb_wrap_sys_device is unavailable in that build.
         */
        virtual std::shared_ptr<uac_device_handle> wrap_android(
                int vid, int pid, int busnum, int devaddr, int fd, const char *usbfs) = 0;
    };
